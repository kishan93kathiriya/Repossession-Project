				...
				function(e) {
					...
					var t = {
						init : function(t) {
							...
							this.options.layout = this.options.custom ? e.noty.layouts["inline"]
									: e.noty.layouts[this.options.layout];
							if (e.noty.themes[this.options.theme])
								this.options.theme = e.noty.themes[this.options.theme];
							else
								t.themeClassName = this.options.theme;
							delete t.layout;
							delete t.theme;
							this.options = e.extend({}, this.options,
						...
						_build : function() {
							var t = e(
									'<div class="noty_bar noty_type_'
											+ this.options.type + '"></div>')
									.attr("id", this.options.id);
							t.append(this.options.template).find(".noty_text")
									.html(this.options.text);
							this.$bar = this.options.layout.parent.object !== null ? e(
									this.options.layout.parent.object).css(
									this.options.layout.parent.css).append(t)
									: t;
							if (this.options.themeClassName)
								this.$bar.addClass(this.options.themeClassName)
										.addClass(
												"noty_container_type_"
														+ this.options.type);
							if (this.options.buttons) {
								this.options.closeWith = [];
								this.options.timeout = false;
								var n = e("<div/>").addClass("noty_buttons");
								this.options.layout.parent.object !== null ? this.$bar
										.find(".alert").append(n)
										: this.$bar.append(n);
								var r = this;
								e
						...
						show : function() {
							var t = this;
							t.options.custom ? t.options.custom.find(
									t.options.layout.container.selector)
									.append(t.$bar) : e(
									t.options.layout.container.selector)
									.append(t.$bar);
							if (t.options.theme && t.options.theme.style)
								t.options.theme.style.apply(t);
							e.type(t.options.layout.css) === "function" ? this.options.layout.css
									.apply(t.$bar)
									: t.$bar.css(this.options.layout.css || {});
							t.$bar.addClass(t.options.layout.addClass);
							t.options.layout.container.style
									.apply(e(t.options.layout.container.selector));
							t.showing = true;
							if (t.options.theme && t.options.theme.style)
								t.options.theme.callback.onShow.apply(this);
							if (e.inArray("click", t.options.closeWith) > -1)
								t.$bar
										.css("cursor", "pointer")
										.one(
												"click",
												function(e) {
													t.stopPropagation(e);
													if (t.options.callback.onCloseClick) {
														t.options.callback.onCloseClick
																.apply(t)
													}
													t.close()
												});
							if (e.inArray("hover", t.options.closeWith) > -1)
								t.$bar.one("mouseenter", function() {
									t.close()
								});
							if (e.inArray("button", t.options.closeWith) > -1)
								t.$closeButton.one("click", function(e) {
									t.stopPropagation(e);
									t.close()
								});
							if (e.inArray("button", t.options.closeWith) == -1)
								t.$closeButton.remove();
							if (t.options.callback.onShow)
								t.options.callback.onShow.apply(t);
							if (typeof t.options.animation.open == "string") {
								t.$bar.css("height", t.$bar.innerHeight());
								t.$bar
										.show()
										.addClass(t.options.animation.open)
										.one(
												"webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
												function() {
													if (t.options.callback.afterShow)
								...
								t.$bar.animate(t.options.animation.open,
										t.options.animation.speed,
										t.options.animation.easing, function() {
											if (t.options.callback.afterShow)
												t.options.callback.afterShow
														.apply(t);
											t.showing = false;
							...
							if (t.options.timeout)
								t.$bar.delay(t.options.timeout).promise().done(
										function() {
											t.close()
										});
							return this
						...
						close : function() {
							if (this.closed)
								return;
							if (this.$bar
									&& this.$bar.hasClass("i-am-closing-now"))
								return;
							var t = this;
							if (this.showing) {
							...
							if (typeof t.options.animation.close == "string") {
								t.$bar
										.addClass(t.options.animation.close)
										.one(
												"webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
												function() {
													if (t.options.callback.afterClose)
														t.options.callback.afterClose
																.apply(t);
													t.closeCleanUp()
												})
							} else {
								t.$bar.clearQueue().stop().animate(
						...
						closeCleanUp : function() {
							...
							if (t.options.modal) {
								...
								if (e.notyRenderer.getModalCount() == 0)
									e(".noty_modal").fadeOut("fast",
											function() {
												e(this).remove()
											})
							}
							e.notyRenderer.setLayoutCountFor(t, -1);
							if (e.notyRenderer.getLayoutCountFor(t) == 0)
								e(t.options.layout.container.selector).remove();
							if (typeof t.$bar !== "undefined"
									&& t.$bar !== null) {
								if (typeof t.options.animation.close == "string") {
									t.$bar.css("transition", "all 100ms ease")
									...
									t.$bar
											.one(
													...
													function() {
														...
														t.$bar = null;
														t.closed = true;
														if (t.options.theme.callback
																&& t.options.theme.callback.onClose) {
															t.options.theme.callback.onClose
																	.apply(t)
														}
													})
						...
						setText : function(e) {
							if (!this.closed) {
								this.options.text = e;
								this.$bar.find(".noty_text").html(e)
							}
							return this
						},
						setType : function(e) {
					...
					e.notyRenderer.init = function(n) {
						...
						if (r.options.killer)
							e.noty.closeAll();
						r.options.force ? e.noty.queue.unshift(r)
								: e.noty.queue.push(r);
						e.notyRenderer.render();
					...
					e.notyRenderer.render = function() {
						...
						if (e.type(t) === "object") {
							if (t.options.dismissQueue) {
								if (t.options.maxVisible > 0) {
									if (e(t.options.layout.container.selector
											+ " li").length < t.options.maxVisible) {
										e.notyRenderer.show(e.noty.queue
												.shift())
									} else {
									}
								} else {
					...
					e.notyRenderer.show = function(t) {
						...
						if (t.options.custom) {
							if (t.options.custom
									.find(t.options.layout.container.selector).length == 0) {
								t.options.custom.append(e(
										t.options.layout.container.object)
										.addClass("i-am-new"))
							} else {
								t.options.custom.find(
										t.options.layout.container.selector)
							...
							if (e(t.options.layout.container.selector).length == 0) {
								e("body").append(
										e(t.options.layout.container.object)
												.addClass("i-am-new"))
							} else {
								e(t.options.layout.container.selector)
										.removeClass("i-am-new")
							}
						}
						e.notyRenderer.setLayoutCountFor(t, +1);
					...
					e.notyRenderer.createModalFor = function(t) {
						if (e(".noty_modal").length == 0) {
							var n = e("<div/>").addClass("noty_modal")
									.addClass(t.options.theme).data(
											"noty_modal_count", 0);
							if (t.options.theme.modal
									&& t.options.theme.modal.css)
								n.css(t.options.theme.modal.css);
							n.prependTo(e("body")).fadeIn("fast");
							if (e.inArray("backdrop", t.options.closeWith) > -1)
					...
					e.noty.themes.defaultTheme = {
						...
						style : function() {
							...
							this.$bar.on({
								mouseenter : function() {
									e(this).find(".noty_close").stop().fadeTo(
											"normal", 1)
								},
								mouseleave : function() {
									e(this).find(".noty_close").stop().fadeTo(
						...
						callback : {
							onShow : function() {
								e.noty.themes.defaultTheme.helpers.borderFix
										.apply(this)
							},
							onClose : function() {
								e.noty.themes.defaultTheme.helpers.borderFix
